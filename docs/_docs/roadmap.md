...
Understand what you do   2.14  The window shows that it is running
                         ...
                         2.22  What it counts can be asked for

Be able to maintain it   2.23  Every entry has a why and an until
                         2.24  Whoever knocks gets locked out
                         2.25  Other people's lists, and countries

Reach further            2.26  One package, four formats
                         2.27  Moving off the firewall already running
                         2.28  Updates arrive on their own
                         2.29  Every rule knows its interface
                         2.30  Outbound traffic
                         2.31  With a keyboard and with a screen reader
                         2.32  Eight languages
