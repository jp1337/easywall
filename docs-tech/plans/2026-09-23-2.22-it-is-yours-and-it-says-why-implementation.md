...
- Task 11's decision row *Blacklist network log* and its *Found, not fixed* entry P5-1 describe the mapped gap as open. The controller rewrites both to "fixed by Task 13".
