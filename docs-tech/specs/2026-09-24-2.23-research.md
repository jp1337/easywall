...
- FP handling: GitHub issues or Hagezi's support address, best-effort, "no guaranteed response time"; a public **Blocklist Lookup** (domains and IPv4) tells users which list/rule blocks an entry; one-off benchmark against 10,000 Umbrella Top-1M sites.
